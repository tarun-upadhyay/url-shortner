    ...
    <>
      ...
      <div className="flex sm:flex-col md:flex-row mx-auto mt-20 p-5 borde justify-between gap-30">
        <div className="flex flex-col p-5 md:w-[80%]">
          ...
          <p className="text-xl font-thin mt-2 text-para">
            Create short links, QR Codes, and Link-in-bio pages.
          </p>
          <p className="text-xl font-thin text-para">
            Share them anywhere. Track what’s working, and what’s not.
          </p>
          <p className="text-xl font-extralight text-para">
            {" "}
            All inside the Bitly Connections Platform.
          </p>
          <div className="md:w-[40%] mt-8 flex flex-col justify-center items-center space-y-3">
            <button
              type="button"
            ...
            <p className="text-blue-700 md:mr-10 cursor:hover">Get a Quote</p>
          </div>
        </div>
